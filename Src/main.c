...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	static Event_Task_Handle_t control_task_handle,chassis_task_handle,gimbal_task_handle,shoot_task_handle,USB_task_handle,AA_task_handle;
	Event_OS_Task_Register(&gimbal_task_handle,1,EOS_High_Priority,Gimbal_Init,Gimbal_Task,NULL);
